...
router.put('/:id', authMiddleware, roleMiddleware(['admin']), filmController.update.bind(filmController));
router.delete('/:id', authMiddleware, roleMiddleware(['admin']), filmController.destroy.bind(filmController));
